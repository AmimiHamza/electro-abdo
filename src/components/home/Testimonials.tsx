          ...
          {testimonials.map((testimonial, i) => {
            ...
            return (
              <motion.div
                ...
                className="card p-5 flex-shrink-0 w-72 md:w-auto flex flex-col gap-3"
              >
                {/* Quote icon */}
                <Quote className="w-8 h-8 text-accent/30 -scale-x-100" />
                ...
                <div className="flex items-center justify-between pt-2 border-t border-border">
                  <div className="flex items-center gap-2.5">
                    {/* Avatar */}
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-accent/30 to-blue-400/30 flex items-center justify-center font-bold text-accent text-sm">
